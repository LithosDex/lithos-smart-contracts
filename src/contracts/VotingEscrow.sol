...
contract VotingEscrow is IERC721, IERC721Metadata, IVotes {
    ...
    /// @param token_addr `LITHOS` token address
    ...
    string public constant name = "veLithos";
    string public constant symbol = "veLITHOS";
    ...
    uint internal constant MAXTIME = 2 * 365 * 86400; // 2 years

...
contract RouterV2 {
        ...
        returns (uint256 reserveA, uint256 reserveB)
    {
        ...
        (uint256 reserve0, uint256 reserve1,) = IBaseV1Pair(pairFor(tokenA, tokenB, stable)).getReserves();
    ...
    function swapExactTokensForTokensSupportingFeeOnTransferTokens(
        ...
        uint256 balanceBefore = erc20(routes[routes.length - 1].to).balanceOf(to);

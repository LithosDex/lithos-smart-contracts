...
contract PairAPI is Initializable {
    ...
    function getAllPair(
        ...
        for (uint idx = 0; idx < _amounts; idx++) {
            ...
            address pairAddr = _pairAddressAtIndex(target);
            Pairs[idx] = _pairAddressToInfo(pairAddr, _user);
            filled = idx + 1;
        }
    ...
    function _pairAddressToInfo(
        ...
        _pairInfo.stable = isFactoryPair ? ipair.isStable() : false;
        ...
        _pairInfo.claimable0 = isFactoryPair ? ipair.claimable0(_account) : 0;
        ...
        _pairInfo.claimable1 = isFactoryPair ? ipair.claimable1(_account) : 0;
    ...
    function _resolvePairFactories(
        ...
        revert("PairAPI: factory not found");
    }

    function _refreshPairFactories(address _voter) internal {
        address[] memory factories = _resolvePairFactories(_voter);
        ...
        pairFactory = IPairFactory(factories[0]);
    }

...
contract LithosTest is Test {
    ...
    function test_StateConsistency_TotalSupplyTracking() public {
        ...
        uint totalBalance = lithos.balanceOf(user1) + lithos.balanceOf(user2) + lithos.balanceOf(recipient);
    ...
    function test_StateConsistency_BalanceConservation() public {
        ...
        uint initialTotal = lithos.balanceOf(user1) + lithos.balanceOf(user2) + lithos.balanceOf(user3);
        ...
        uint finalTotal = lithos.balanceOf(user1) + lithos.balanceOf(user2) + lithos.balanceOf(user3);

...
export class Pair extends ethereum.SmartContract {
  ...
  try_currentCumulativePrices(): ethereum.CallResult<Pair__currentCumulativePricesResult> {
    let result = super.tryCall(
      "currentCumulativePrices",
      "currentCumulativePrices():(uint256,uint256,uint256)",
      [],
  ...
  isStable(): boolean {
    let result = super.call("isStable", "isStable():(bool)", []);

    return result[0].toBoolean();
  }

  try_isStable(): ethereum.CallResult<boolean> {
    let result = super.tryCall("isStable", "isStable():(bool)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  try_lastObservation(): ethereum.CallResult<Pair__lastObservationResultValue0Struct> {
    let result = super.tryCall(
      "lastObservation",
      "lastObservation():((uint256,uint256,uint256))",
      [],
...
export class ClaimStakingFeesCall extends ethereum.Call {
  get inputs(): ClaimStakingFeesCall__Inputs {
    return new ClaimStakingFeesCall__Inputs(this);
  }

  get outputs(): ClaimStakingFeesCall__Outputs {
    return new ClaimStakingFeesCall__Outputs(this);
  }
}

export class ClaimStakingFeesCall__Inputs {
  _call: ClaimStakingFeesCall;

  constructor(call: ClaimStakingFeesCall) {
    this._call = call;
  }
}

export class ClaimStakingFeesCall__Outputs {
  _call: ClaimStakingFeesCall;
